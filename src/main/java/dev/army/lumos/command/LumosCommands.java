...
public class LumosCommands {
    public static void register(CommandDispatcher<ServerCommandSource> dispatcher) {
        dispatcher.register(CommandManager.literal("lumos").executes(LumosCommands::root).then(CommandManager.literal("config").executes(LumosCommands::config).then(CommandManager.literal("reload").executes(LumosCommands::reload))));
    }
